...
namespace slamware_ros_sdk
{
    ...
    SlamwareRosSdkServer::SlamwareRosSdkServer()
            : state_(ServerStateNotInit), isStopRequested_(false)
//        , nh_(rclcpp::Node::make_shared("global_rrt_frontier_detector"))
    {
        //
        nh_ = rclcpp::Node::make_shared("slamware_ros_sdk_server_node");
        tfBrdcstr_ = std::make_shared<tf2_ros::TransformBroadcaster>(nh_);
    }
    ...
    SlamwareRosSdkServer::slamware_platform_t
    SlamwareRosSdkServer::connectSlamwarePlatform_(const std::string &ip, int port) const
    {
        try
        {
        ...
        {
            RCLCPP_ERROR(nh_->get_logger(), "connectSlamwarePlatform_(), exception: %s.", excp.what());
        }
        catch (...)
        {
            RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "connectSlamwarePlatform_(), unknown exception.");
        }
    ...
    void SlamwareRosSdkServer::disconnectSlamwarePlatform_(slamware_platform_t &pltfm) const
    {
        if (pltfm)
        {
            ...
            {
                RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "disconnectSlamwarePlatform_(), exception: %s.",
                             excp.what());
            }
            catch (...)
            {
                RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "disconnectSlamwarePlatform_(), unknown exception.");
            }
        }
    }
    ...
    bool SlamwareRosSdkServer::init_(std::string & /*errMsg*/)
    {
        ...
        // init all workers
        {
            ...
            {
                auto svrWk = boost::make_shared<ServerRobotDeviceInfoWorker>(this, "RobotDeviceInfo",
                                                                             defaultUpdateIntervalForNoneUpdateWorkers);
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.robot_pose_pub_period)
            {
                auto svrWk = boost::make_shared<ServerRobotPoseWorker>(this, "RobotPose", sfConvFloatSecToBoostMs_(
                        params_.robot_pose_pub_period));
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.map_update_period)
            {
                auto svrWk = boost::make_shared<ServerExploreMapUpdateWorker>(this, "ExploreMapUpdate",
                                                                              sfConvFloatSecToBoostMs_(
                                                                                      params_.map_update_period));
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.map_pub_period)
            {
                auto svrWk = boost::make_shared<ServerExploreMapPublishWorker>(this, "ExploreMapPublish",
                                                                               sfConvFloatSecToBoostMs_(
                                                                                       params_.map_pub_period));
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.scan_pub_period)
            {
                auto svrWk = boost::make_shared<ServerLaserScanWorker>(this, "LaserScan", sfConvFloatSecToBoostMs_(
                        params_.scan_pub_period));
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.basic_sensors_info_update_period)
            {
                auto svrWk = boost::make_shared<ServerBasicSensorsInfoWorker>(this, "BasicSensorsInfo",
                                                                              sfConvFloatSecToBoostMs_(
                                                                                      params_.basic_sensors_info_update_period));
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.basic_sensors_values_pub_period)
            {
                auto svrWk = boost::make_shared<ServerBasicSensorsValuesWorker>(this, "BasicSensorsValues",
                                                                                sfConvFloatSecToBoostMs_(
                                                                                        params_.basic_sensors_values_pub_period));
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.path_pub_period)
            {
                auto svrWk = boost::make_shared<ServerPlanPathWorker>(this, "PlanPath", sfConvFloatSecToBoostMs_(
                        params_.path_pub_period));
                serverWorkers_.push_back(svrWk);
            }

            if (0 < params_.robot_basic_state_pub_period)
            {
                auto svrWk = boost::make_shared<ServerRobotBasicStateWorker>(this, "RobotBasicState",
                                                                             sfConvFloatSecToBoostMs_(
                                                                                     params_.robot_basic_state_pub_period));
                serverWorkers_.push_back(svrWk);
            }
            ...
            if (0 < params_.virtual_walls_pub_period)
            {
                ...
                auto svrWk = boost::make_shared<ServerArtifactLinesWorker>(this, "VirtualWalls",
                                                                           sfConvFloatSecToBoostMs_(
                                                                                   params_.virtual_walls_pub_period),
                                                                           tParams);
                serverWorkers_.push_back(svrWk);
            }
            ...
            if (0 < params_.virtual_tracks_pub_period)
            {
                ...
                auto svrWk = boost::make_shared<ServerArtifactLinesWorker>(this, "VirtualTracks",
                                                                           sfConvFloatSecToBoostMs_(
                                                                                   params_.virtual_tracks_pub_period),
                                                                           tParams);
                serverWorkers_.push_back(svrWk);
            }
        }
        ...
        // init all subscriptions
        {
            ...
            subRecoverLocalization_ = subscribe_T_<RecoverLocalizationRequest>("recover_localization", 1U,
                                                                               &SlamwareRosSdkServer::msgCbRecoverLocalization_);
            subClearMap_ = subscribe_T_<ClearMapRequest>("clear_map", 1U, &SlamwareRosSdkServer::msgCbClearMap_);
            subSetMapUpdate_ = subscribe_T_<SetMapUpdateRequest>("set_map_update", 1U,
            ...
            subRemoveLine_ = subscribe_T_<RemoveLineRequest>("remove_line", 1U,
                                                             &SlamwareRosSdkServer::msgCbRemoveLine_);
            subClearLines_ = subscribe_T_<ClearLinesRequest>("clear_lines", 1U,
                                                             &SlamwareRosSdkServer::msgCbClearLines_);
        ...
        // init all services
        {
            srvSyncGetStcm_ = advertiseService_T_<slamware_ros_msgs::srv::SyncGetStcm>("sync_get_stcm",
                                                                                       &SlamwareRosSdkServer::srvCbSyncGetStcm_);

            srvSyncSetStcm_ = advertiseService_T_<slamware_ros_msgs::srv::SyncSetStcm>("sync_set_stcm",
                                                                                       &SlamwareRosSdkServer::srvCbSyncSetStcm_);
        }


        //            subRobotControl_ = nh_->create_subscription<geometry_msgs::msg::Twist>(params_.vel_control_topic, 10U,
//                                                                                   (std::function<void(
//                                                                                           std::shared_ptr<geometry_msgs::msg::Twist>)>)
//                                                                                           std::bind(
//                                                                                                   &SlamwareRosSdkServer::msgCbRobotControl_,
//                                                                                                   this,
//                                                                                                   safeGetSlamwarePlatform_(),
//                                                                                                   std::placeholders::_1));
//
//            subMoveToGoal_ = nh_->create_subscription<geometry_msgs::msg::PoseStamped>(params_.goal_topic, 1U,
//                                                                                       (std::function<void(
//                                                                                               std::shared_ptr<geometry_msgs::msg::PoseStamped>)>)
//                                                                                               std::bind(
//                                                                                                       &SlamwareRosSdkServer::msgCbMoveToGoal_,
//                                                                                                       this,
//                                                                                                       safeGetSlamwarePlatform_(),
//                                                                                                       std::placeholders::_1));
//
//            subSyncMap_ = nh_->create_subscription<SyncMapRequest>("sync_map", 1U,
//                                                                   (std::function<void(
//                                                                           std::shared_ptr<SyncMapRequest>)>)
//                                                                           std::bind(
//                                                                                   &SlamwareRosSdkServer::msgCbSyncMap_,
//                                                                                   this,
//                                                                                   safeGetSlamwarePlatform_(),
//                                                                                   std::placeholders::_1));
//
//            subSetPose_ = nh_->create_subscription<geometry_msgs::msg::Pose>("set_pose", 1U,
//                                                                             (std::function<void(
//                                                                                     std::shared_ptr<geometry_msgs::msg::Pose>)>)
//                                                                                     std::bind(
//                                                                                             &SlamwareRosSdkServer::msgCbSetPose_,
//                                                                                             this,
//                                                                                             safeGetSlamwarePlatform_(),
//                                                                                             std::placeholders::_1));
//            subRecoverLocalization_ = nh_->create_subscription<RecoverLocalizationRequest>("recover_localization", 1U,
//                                                                             (std::function<void(
//                                                                                     std::shared_ptr<RecoverLocalizationRequest>)>)
//                                                                                     std::bind(
//                                                                                             &SlamwareRosSdkServer::msgCbRecoverLocalization_,
//                                                                                             this,
//                                                                                             safeGetSlamwarePlatform_(),
//                                                                                             std::placeholders::_1));
//            subClearMap_ = nh_->create_subscription<ClearMapRequest>("clear_map", 1U,
//                                                                                           (std::function<void(
//                                                                                                   std::shared_ptr<ClearMapRequest>)>)
//                                                                                                   std::bind(
//                                                                                                           &SlamwareRosSdkServer::msgCbClearMap_,
//                                                                                                           this,
//                                                                                                           safeGetSlamwarePlatform_(),
//                                                                                                           std::placeholders::_1));
//            subSetMapUpdate_ = nh_->create_subscription<SetMapUpdateRequest>("set_map_update", 1U,
//                                                                     (std::function<void(
//                                                                             std::shared_ptr<SetMapUpdateRequest>)>)
//                                                                             std::bind(
//                                                                                     &SlamwareRosSdkServer::msgCbSetMapUpdate_,
//                                                                                     this,
//                                                                                     safeGetSlamwarePlatform_(),
//                                                                                     std::placeholders::_1));
//            subSetMapLocalization_ = nh_->create_subscription<SetMapLocalizationRequest>("set_map_localization", 1U,
//                                                                             (std::function<void(
//                                                                                     std::shared_ptr<SetMapLocalizationRequest>)>)
//                                                                                     std::bind(
//                                                                                             &SlamwareRosSdkServer::msgCbSetMapLocalization_,
//                                                                                             this,
//                                                                                             safeGetSlamwarePlatform_(),
//                                                                                             std::placeholders::_1));
//
//            subMoveByDirection_ = nh_->create_subscription<MoveByDirectionRequest>("move_by_direction", 1U,
//                                                                                         (std::function<void(
//                                                                                                 std::shared_ptr<MoveByDirectionRequest>)>)
//                                                                                                 std::bind(
//                                                                                                         &SlamwareRosSdkServer::msgCbMoveByDirection_,
//                                                                                                         this,
//                                                                                                         safeGetSlamwarePlatform_(),
...
//            srvSyncSetStcm_ = ros::ServiceServer();
            srvSyncGetStcm_.reset();
            srvSyncSetStcm_.reset();
        }

        // de-init all subscriptions
        {
            subRobotControl_.reset();
            subMoveToGoal_.reset();

            subSyncMap_.reset();
            subSetPose_.reset();

            subRecoverLocalization_.reset();
            subClearMap_.reset();
            subSetMapUpdate_.reset();
            subSetMapLocalization_.reset();

            subMoveByDirection_.reset();
            subMoveByTheta_.reset();
            subMoveTo_.reset();
            subMoveToLocations_.reset();
            subRotateTo_.reset();
            subRotate_.reset();

            subGoHome_.reset();
            subCancelAction_.reset();

            subAddLine_.reset();
            subAddLines_.reset();
            subRemoveLine_.reset();
            subClearLines_.reset();
            subMoveLine_.reset();
            subMoveLines_.reset();

//            subRobotControl_ = ros::sub Subscriber();
...
//            subMoveLines_ = ros::Subscriber();
    ...
    void SlamwareRosSdkServer::workThreadFun_()
    {
        ...
        RCLCPP_INFO(rosNodeHandle_()->get_logger(), "SlamwareRosSdkServer, work thread begin.");
                ...
                )
        {
            ...
            {
                RCLCPP_FATAL(rosNodeHandle_()->get_logger(), "loopWork_(), exception: %s.", excp.what());
            }
            catch (...)
            {
                RCLCPP_FATAL(rosNodeHandle_()->get_logger(), "loopWork_(), unknown exception.");
            }
            ...
            if (shouldContinueRunning_())
            {
                ...
                RCLCPP_INFO(rosNodeHandle_()->get_logger(), "wait %u ms to reconnect and restart work loop.",
                            maxSleepMs);
                roughSleepWait_(maxSleepMs, 100U);
            }
        }

        RCLCPP_INFO(rosNodeHandle_()->get_logger(), "SlamwareRosSdkServer, work thread end.");
    ...
    void SlamwareRosSdkServer::loopTryConnectToSlamwarePlatform_()
    {
        ...
        {
            {
                RCLCPP_INFO(rosNodeHandle_()->get_logger(), "try to connect to %s:%d, tryCnt: %u.",
                            params_.ip_address.c_str(), params_.robot_port, tryCnt);
                auto pltfm = connectSlamwarePlatform_(params_.ip_address, params_.robot_port);
                if (pltfm)
                {
                    RCLCPP_INFO(rosNodeHandle_()->get_logger(), "connect to %s:%d, OK, tryCnt: %u.",
                                params_.ip_address.c_str(), params_.robot_port, tryCnt);
                    safeSetSlamwarePlatform_(pltfm);
                    return;
                }
                RCLCPP_ERROR(rosNodeHandle_()->get_logger(),
                             "connect to %s:%d, FAILED, tryCnt: %u, wait %d ms to retry.", params_.ip_address.c_str(),
                             params_.robot_port, tryCnt, params_.reconn_wait_ms);
            }

            const std::uint32_t maxSleepMs = (0 <= params_.reconn_wait_ms ? (std::uint32_t) params_.reconn_wait_ms
                                                                          : 0U);
            roughSleepWait_(maxSleepMs, 100U);
            ++tryCnt;
        }
    ...
    bool SlamwareRosSdkServer::reinitWorkLoop_(slamware_platform_t &pltfm)
    {
        ...
        RCLCPP_INFO(rosNodeHandle_()->get_logger(), "reset all %u workers on work loop begin.", cntWorkers);
        for (auto it = serverWorkers_.begin(), itEnd = serverWorkers_.end(); itEnd != it; ++it)
        {
            ...
            {
                RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "worker: %s, resetOnWorkLoopBegin(), exception: %s.",
                             wkName.c_str(), excp.what());
                return false;
            }
        }
        ...
        for (std::uint32_t t = 1; (t <= maxLoopTryCnt && shouldContinueRunning_()); ++t)
        {
                ...
                try
                {
                    ...
                    else
                    {
                        if (svrWk->reinitWorkLoop(pltfm))
                        {
                            ...
                            RCLCPP_WARN(rosNodeHandle_()->get_logger(), "failed to init work loop, woker: %s.",
                                        wkName.c_str());
                    }
                }
                catch (const rpos::robot_platforms::ConnectionLostException &excp)
                {
                    RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "worker: %s, reinitWorkLoop(), exception: %s.",
                                 wkName.c_str(), excp.what());
                    throw;
                }
            ...
            {
                RCLCPP_WARN(rosNodeHandle_()->get_logger(), "(%u / %u) cntWorkers: %u, cntOk: %u, wait %u ms to retry.",
                            t, maxLoopTryCnt, cntWorkers, cntOk, maxSleepMs);
                roughSleepWait_(maxSleepMs, 100U);
            }
            else
            {
                RCLCPP_WARN(rosNodeHandle_()->get_logger(), "(%u / %u) cntWorkers: %u, cntOk: %u.", t, maxLoopTryCnt,
                            cntWorkers, cntOk);
            }
        }
        return false;
    ...
    void SlamwareRosSdkServer::loopWork_()
    {
        ...
        {
            RCLCPP_INFO(rosNodeHandle_()->get_logger(), "successed to reinit all workers on work loop begin.");
        }
        else
        {
            RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "failed or cancelled to reinit work loop.");
            return;
        }

        while (shouldContinueRunning_())
        {
            boost::chrono::steady_clock::time_point minNextTriggerTimepoint =
                    boost::chrono::steady_clock::now() + boost::chrono::milliseconds(100U);
            ...
            for (auto it = serverWorkers_.begin(), itEnd = serverWorkers_.end(); itEnd != it; ++it)
            {
                ...
                catch (const rpos::robot_platforms::ConnectionLostException &excp)
                {
                    ...
                    RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "worker name: %s, exception: %s.", wkName.c_str(),
                                 excp.what());
                }
                catch (const rpos::robot_platforms::ConnectionTimeOutException &excp)
                {
                ...
                {
                    RCLCPP_WARN(rosNodeHandle_()->get_logger(), "worker name: %s, exception: %s.", wkName.c_str(),
                                excp.what());
                }
                ...
                {
                    RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "worker name: %s, unknown exception.", wkName.c_str());
                }

                if (shouldReconnect)
                {
                    RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "it should reconnect to slamware.");
                    return;
                }
            ...
            {
                const auto durSleep = boost::chrono::duration_cast<boost::chrono::milliseconds>(
                        minNextTriggerTimepoint - tpNow);
    ...
    )
    {
        ...
        {
            RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "process msgTopic: %s, exception: %s.", msgTopic.c_str(),
                         excp.what());
        }
        catch (...)
        {
            RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "process msgTopic: %s, unknown exception.", msgTopic.c_str());
        }
    }

    template<class MsgT>
    typename rclcpp::Subscription<MsgT>::SharedPtr
    SlamwareRosSdkServer::subscribe_T_(const std::string &msgTopic, std::uint32_t queueSize,
    ...
    )
    {
        ...
        typename TheMsgCbHelpT::ros_cb_fun_t rosCbFun(
                std::bind(&SlamwareRosSdkServer::msgCbWrapperFun_T_<MsgT>, this, mfpCbPerform, msgTopic, std::placeholders::_1)
        );
...
//                                                      std::bind(mfpCbPerform, this, safeGetSlamwarePlatform_(), std::placeholders::_1));
//    }
                                                ...
                                                const geometry_msgs::msg::PoseStamped::ConstPtr &msg)
    {
        ...
        optMove.flag = rpos::features::motion_planner::MoveOptionFlag(
                rpos::features::motion_planner::MoveOptionFlagMilestone
    ...
    void SlamwareRosSdkServer::msgCbSetPose_(slamware_platform_t &pltfm, const geometry_msgs::msg::Pose::ConstPtr &msg)
    {
    ...
    void SlamwareRosSdkServer::msgCbRecoverLocalization_(slamware_platform_t &pltfm,
                                                         const RecoverLocalizationRequest::ConstPtr &msg)
    {
    ...
    void SlamwareRosSdkServer::msgCbSetMapLocalization_(slamware_platform_t &pltfm,
    ...
    void
    SlamwareRosSdkServer::msgCbMoveByDirection_(slamware_platform_t &pltfm, const MoveByDirectionRequest::ConstPtr &msg)
    {
    ...
    void
    SlamwareRosSdkServer::msgCbMoveToLocations_(slamware_platform_t &pltfm, const MoveToLocationsRequest::ConstPtr &msg)
    {
    ...
    void
    SlamwareRosSdkServer::msgCbCancelAction_(slamware_platform_t &pltfm, const CancelActionRequest::ConstPtr & /*msg*/)
    {
    ...
    )
    {
        ...
        if (!pltfm)
        {
            RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "process request: %s, not connected.", srvMsgTopic.c_str());
            return false;
        }
        ...
        {
            RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "process request: %s, exception: %s.", srvMsgTopic.c_str(),
                         excp.what());
        }
        catch (...)
        {
            RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "process request: %s, unknown exception.",
                         srvMsgTopic.c_str());
        }
        return false;
    }
...
//    SlamwareRosSdkServer::advertiseService_T_2(const std::string &srvMsgTopic,
//                                       typename srv_cb_help_t<SrvMsgT>::srv_cb_perform_fun_t mfpCbPerform
//    )
//    {
//        return nh_->create_service<SrvMsgT>(srvMsgTopic,
//                                              (std::function<void(std::shared_ptr<SrvMsgT>)>)
//                                                      std::bind(mfpCbPerform, this, safeGetSlamwarePlatform_(), std::placeholders::_1, std::placeholders::_2));
//    }

    template<class SrvMsgT>
    typename rclcpp::Service<SrvMsgT>::SharedPtr
    SlamwareRosSdkServer::advertiseService_T_(const std::string &srvMsgTopic,
                                              typename srv_cb_help_t<SrvMsgT>::srv_cb_perform_fun_t mfpCbPerform
    )
    {
        ...
        typename TheSrvCbHelpT::ros_cb_fun_t rosCbFun(
                std::bind(&SlamwareRosSdkServer::srvCbWrapperFun_T_<SrvMsgT>, this, mfpCbPerform, srvMsgTopic, std::placeholders::_1, std::placeholders::_2)
        );

        return nh_->create_service<SrvMsgT>(srvMsgTopic, rosCbFun);
    }

    bool SlamwareRosSdkServer::srvCbSyncGetStcm_(slamware_platform_t &pltfm,
                                                 std::shared_ptr<slamware_ros_msgs::srv::SyncGetStcm::Request> req,
                                                         std::shared_ptr<slamware_ros_msgs::srv::SyncGetStcm::Response> resp)
    {
        ...
        try
        {
            ...
            {
                RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "srvCbSyncGetStcm_(), saveStream(), %s.", strTmp.c_str());
                return false;
            }
        }
        catch (const std::exception &excp)
        {
            RCLCPP_WARN(rosNodeHandle_()->get_logger(), "srvCbSyncGetStcm_(), exception: %s.", excp.what());
            return false;
        }
    ...
    bool SlamwareRosSdkServer::srvCbSyncSetStcm_(slamware_platform_t &pltfm,
                                                 std::shared_ptr<slamware_ros_msgs::srv::SyncSetStcm::Request> req,
                                                         std::shared_ptr<slamware_ros_msgs::srv::SyncSetStcm::Response> resp)
    {
        ...
        {
            rpos::system::io::MemoryReadStream tMemRS((const void *) req->raw_stcm.data(), req->raw_stcm.size(),
            ...
            if (!spSmpstMap)
            {
                RCLCPP_ERROR(rosNodeHandle_()->get_logger(), "srvCbSyncSetStcm_(), loadStream(), %s.", strTmp.c_str());
                return false;
            }
        }
        ...
        {
            RCLCPP_WARN(rosNodeHandle_()->get_logger(), "srvCbSyncSetStcm_(), exception: %s.", excp.what());
            return false;
        }
